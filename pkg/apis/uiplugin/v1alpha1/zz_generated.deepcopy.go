...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LoggingFrontendConfig) DeepCopyInto(out *LoggingFrontendConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LoggingFrontendConfig.
func (in *LoggingFrontendConfig) DeepCopy() *LoggingFrontendConfig {
	if in == nil {
		return nil
	}
	out := new(LoggingFrontendConfig)
